package io.tlor.spring.data.config;
...
public class DataBaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean demoEntityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "io.tlor.spring.data.model" });
    ...
    public Properties additionalProperties() {
        ...
        // properties.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQLInnoDBDialect");  // 방언
